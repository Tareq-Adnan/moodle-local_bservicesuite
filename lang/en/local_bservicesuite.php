...
$string['precheckfailed'] = "Pre-check failed: {$a}";
$string['invalidbackupfile'] = "Invalid backup file";
$string['emptybackup'] = "Backup file is empty";
$string['backupsuccess'] = "Course backup successful";
$string['restoresuccess'] = "Course restore successful";
$string['backuptosts3'] = "Backup course to S3";
$string['restorefroms3'] = "Restore course from S3";
$string['backuptosts3desc'] = "Backup a course and upload the backup file";
